    ...
    <div className="animate-tab-enter space-y-5">
      ...
      <div className="bg-card rounded-2xl p-5 border border-card">
        ...
        <div className="space-y-1">
          {[
            { name: t("menu.ensoDashboard", locale), desc: t("menu.ensoDashboardDesc", locale), href: "https://ensolife.app/dashboard", logo: <><circle cx="50" cy="50" r="32" stroke="currentColor" strokeWidth="5" fill="none" opacity="0.9" /></> },
